...
const MATCHES = [
  ...
  mk(25,'2026-06-18T16:00:00Z','Czech Republic','South Africa','A','Atlanta'),
  mk(28,'2026-06-19T01:00:00Z','Mexico','South Korea','A','Guadalajara'),
  mk(53,'2026-06-25T01:00:00Z','Czech Republic','Mexico','A','Mexico City'),
  ...
  mk(49,'2026-06-24T19:00:00Z','Switzerland','Canada','B','Vancouver'),
  mk(50,'2026-06-24T19:00:00Z','Bosnia-Herzegovina','Qatar','B','Seattle'),
  mk(6, '2026-06-13T22:00:00Z','Brazil','Morocco','C','New York/NJ'),
  mk(7, '2026-06-14T01:00:00Z','Haiti','Scotland','C','Boston'),
  mk(30,'2026-06-19T22:00:00Z','Scotland','Morocco','C','Boston'),
  mk(31,'2026-06-20T00:30:00Z','Brazil','Haiti','C','Philadelphia'),
  ...
  mk(8, '2026-06-14T04:00:00Z','Australia','Türkiye','D','Vancouver'),
  mk(29,'2026-06-19T19:00:00Z','USA','Australia','D','Seattle'),
  mk(32,'2026-06-20T03:00:00Z','Türkiye','Paraguay','D','San Francisco'),
  mk(59,'2026-06-26T02:00:00Z','Türkiye','USA','D','Los Angeles'),
  ...
  mk(18,'2026-06-16T22:00:00Z','Iraq','Norway','I','Boston'),
  ...
  mk(70,'2026-06-27T23:30:00Z','DR Congo','Uzbekistan','K','Atlanta'),
  ...
  mk(85,'2026-07-03T03:00:00Z','1st B','Best 3rd (E/F/G/I/J)',null,'Vancouver','r32'),
...
const COUNTRIES = [
  ...
  { code:'tr', flag:'🇹🇷', name:'Türkiye',         station:'TRT Spor',              tz:'Europe/Istanbul' },
    ...
    return (
      <div style={S.evRow}>
        <div style={S.evGrid}>
          ...
          {!mobile && (
            <div style={S.evIcon}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width={28} height={28} fill={pal.fg}>
                <path d="M14.92,8.1v.59h1.44l.97.97v1.88h-2.06l-1.47,2.05h-1.65l-1.08-1.51v-1.94c0-.79.65-1.44,1.44-1.44h1.83v-.59h-1.83c-1.12,0-2.03.91-2.03,2.03v2.13l1.37,1.91h2.26l1.47-2.05h2.34v-2.71l-1.31-1.31h-1.68Z"/>
                <path d="M20.93,13.57h-2.45l-1.37,2.05h-3.23c-.95,0-1.84.35-2.53,1-.27-1.98-1.77-3.56-3.7-3.96l1.39-1.86v-3.36l-2.07-2.07c.65-.74,1.43-1.37,2.3-1.84h0l1.73,1.74h2.74l.93.93c.92.95,2.58.26,2.57-1.06v-1.52c2.5,1.42,4.19,4.1,4.19,7.17,0,.98-.17,1.91-.49,2.79h0ZM13.17,19.03c-.69,0-1.37-.08-2.03-.25.15-.43.23-.89.25-1.37.66-.72,1.49-1.2,2.49-1.19h3.55l1.37-2.05h1.89c-1.29,2.87-4.18,4.87-7.52,4.87h0ZM8.43,13.54c.48.22.91.54,1.27.92h-.97l-.3-.92h0ZM9.61,17.88l-1.24-.53-.45-1.4.74-.91h1.5c.37.57.6,1.25.64,1.97l-1.19.87h0ZM10.29,19.25l-.3-.92.79-.57c-.06.54-.23,1.04-.49,1.5h0ZM8.2,21.09l-1.21-.88v-1.45l1.17-.85,1.24.53.47,1.43c-.44.54-1.02.96-1.67,1.22h0ZM6.7,21.37c-.27,0-.53-.03-.78-.08l.79-.57.79.57c-.26.05-.52.08-.79.08h0ZM3.52,19.87l.46-1.43,1.25-.53,1.17.85v1.45l-1.21.88c-.66-.26-1.23-.68-1.68-1.22h0ZM3.11,19.26c-.25-.45-.42-.96-.49-1.49l.79.57-.3.92h0ZM3.23,15.05h1.5l.76.91-.45,1.4-1.25.53-1.19-.87c.04-.72.27-1.4.64-1.97h0ZM4.96,13.54l-.3.93h-.97c.36-.38.79-.7,1.27-.93h0ZM7.78,17.46l-1.08.79-1.08-.79.41-1.27h1.34l.41,1.27h0ZM7.44,15.6h-1.49l-.76-.91.46-1.41c.33-.09.68-.13,1.04-.13h0c.36,0,.7.05,1.03.13l.46,1.41-.74.91h0ZM4.93,10.79c0-1.86.62-3.58,1.66-4.96l1.86,1.85v2.92l-1.47,1.97c-.61-.04-1.24.05-1.8.24-.17-.66-.25-1.34-.25-2.03h0ZM13.17,2.55c1.24,0,2.41.27,3.47.77v1.82c0,.8-1,1.22-1.56.65l-1.1-1.1h-2.74l-1.42-1.42c1.02-.46,2.16-.71,3.35-.71h0ZM13.17,1.96c-2.36,0-4.58.92-6.24,2.59-1.67,1.67-2.59,3.88-2.59,6.24,0,.77.1,1.52.29,2.26-1.56.77-2.63,2.37-2.63,4.22,0,2.59,2.11,4.7,4.7,4.7,1.85,0,3.46-1.08,4.22-2.64.73.19,1.49.29,2.25.29,2.36,0,4.58-.92,6.24-2.59,1.67-1.67,2.59-3.88,2.59-6.24s-.92-4.57-2.59-6.24c-1.67-1.67-3.88-2.59-6.24-2.59h0Z"/>
                <polygon points="11.98 9.88 12.57 9.88 12.57 9.29 11.98 9.29 11.98 9.88 11.98 9.88"/>
                <polygon points="13.76 9.88 13.76 9.29 13.17 9.29 13.17 9.88 13.76 9.88 13.76 9.88"/>
                <polygon points="6.99 7.85 6.4 7.85 6.4 8.44 6.99 8.44 6.99 7.85 6.99 7.85"/>
              </svg>
            </div>
          )}
